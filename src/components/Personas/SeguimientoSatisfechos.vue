    ...
    <v-window v-model="step">
          ...
          <v-row>
            ...
            >
              ...
              <template v-slot:[`item.actions`]="{ item }">
                ...
                <v-icon small @click="deleteItem(item)" title="eliminar vecino">
                  mdi-delete
                </v-icon>
              </template>
            </v-data-table>
      ...
      <v-window-item :value="2">
        <v-btn tile outlined dark @click="step--, getPersonas()" color="success"
          >Seguimiento Vecinos Satisfechos</v-btn
        >
  ...
  methods: {
    ...
    getPersonas() {
      ...
      if (
        ...
        axios
          .get(process.env.VUE_APP_SERVICE_URL + "persona/lista")
          .then((response) => {
    ...
    guardarSeguimiento() {
      ...
      if (this.validSeguimiento) {
        axios
          .post(
            process.env.VUE_APP_SERVICE_URL +
              "gestion/seguimientosatisfecho/create",
