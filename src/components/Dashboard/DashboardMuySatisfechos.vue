    ...
    <v-row>
      <v-col class="mb-4">
        ...
        <v-row align="center" justify="space-around">
          <v-btn @click="getMetasSatisfechosAlcaldias()">
            Todas las Alcaldias
          </v-btn>
          ...
          <v-btn align="center" justify="space-around" @click="getMetaRegion()">
            Estado Región 1
          </v-btn>
          <v-btn
            align="center"
...
export default {
  ...
  methods: {
    ...
    getMetaRegion() {
      axios
        .get(process.env.VUE_APP_SERVICE_URL + "dashboard/mntomuymetaregion")
        .then((response) => {
    ...
    getMetasSatisfechosAlcaldias() {
      axios
        .get(process.env.VUE_APP_SERVICE_URL + "dashboard/mntomuysatisfechos")
        .then((response) => {
          this.arreglo = response.data;
        })
        .catch(function (error) {
  ...
  mounted() {
    this.getMetaRegion(), this.getAlcaldias();
  },
};
</script>
