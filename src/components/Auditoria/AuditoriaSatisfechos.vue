      ...
      <v-row>
        <v-col class="mb-4">
          <h1 class="display-1 text-left font-weight-bold mb-3">
            Auditoría: Mantenimiento Peticiones Vecinos Satisfechos
          </h1>
        </v-col>
      </v-row>
      ...
      <v-row>
        <v-col class="mb-4">
          ...
          <download-excel
            ...
            name="Auditoría Seguimientos de Mantenimiento Vecinos Satisfechos.xls"
          >
          ...
          >
            <template v-slot:top>
              <v-toolbar flat>
                ...
                <v-spacer></v-spacer>
                <!--Seguimiento-->
                <v-dialog v-model="dialogSeguimiento" max-width="1000px">
                  <v-card>
                    <v-banner
                      elevation="9"
                      outlined
...
export default {
  ...
  data: () => ({
    ...
    headers: [
      ...
      { text: "Distrito", value: "distrito_id" },
      ...
      axios
        .get(
          process.env.VUE_APP_SERVICE_URL +
            "persona/listaMntoSatisfechosAuditoria/" +
