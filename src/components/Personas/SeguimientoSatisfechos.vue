...
<!-- Acciones Editar-Eliminar -->
                ...
                <v-btn  tile outlined dark @click="step--,getPersonas()" color="success">Seguimiento Vecinos Satisfechos</v-btn>
  ...
  export default {
    ...
    descarga:[],
      ...
      newItem: {
        ...
        "genero": "",
        "liderazgo": "",
        "seguimiento":"1", //Seguimiento 1 corresponde a los vecinos satisfechos.
    ...
    methods: {
        ...
        getPersonas(){
            ...
            {
              axios.get(process.env.VUE_APP_SERVICE_URL+'persona/listaporzonadistrito/'+JSON.parse(localStorage.getItem('alcaldia'))+'/'+JSON.parse(localStorage.getItem('distrito')))
                .then((response)=>{
        ...
        vecinosByName(){
                ...
                axios.get(process.env.VUE_APP_SERVICE_URL+'persona/lista/1/'+this.search.split(' ').join('_'))
                .then((response)=>{
                    this.search = ""
                    this.personas=response.data.persona
                    this.loading=false
      ...
      editarPersona(){
        ...
        putMantenimiento(){
         ...
         this.$swal({
                    title: '¿Trasladar a Seguimiento Muy Satisfecho?',
                    showDenyButton: true,
                    showCancelButton: true,
                    confirmButtonText: 'Si',
                    denyButtonText: `No`,
        ...
        putSeguimientoSatisfecho(){
          console.log(this.editarSeguimiento)
