...
export default {
  ...
  methods: {
    guardarUsuario() {
      ...
      axios
        .post("http://localhost:8000/v1/user/register", this.usuario)
        .then(function () {
    ...
    getAlcaldias() {
      axios
        .get("http://localhost:8000/v1/catalogo/alcaldias")
        .then((response) => {
    ...
    getRoles() {
      axios
        .get("http://localhost:8000/v1/catalogo/roles")
        .then((response) => {
