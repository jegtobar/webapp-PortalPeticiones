<template>
    <v-container>
        <template>
            <v-row>
                <v-col class="mb-4">
                    <h1 class="display-1 text-left font-weight-bold mb-3">Metas Mantenimiento Vecinos Satisfechos</h1>
                     <v-select
  ...
  export default {
    ...
    watch: {
     ...
     getPromotor(){
      ...
      getMetas(){
          axios.get(process.env.VUE_APP_SERVICE_URL+'metas/mntosatisfechos/'+this.alcaldias.alcaldia_id)
                .then((response)=>{
      ...
      guardarMeta(){
        ...
        axios.post(process.env.VUE_APP_SERVICE_URL+'metas/mntosatisfechos/crear', this.newItem)
            .then((response)=>{
      ...
      editarMeta(){
            axios.put(process.env.VUE_APP_SERVICE_URL+'metas/mntosatisfechos/actualizar/'+this.editedItem.id, this.editedItem)
            .then(
                 this.$swal({
                    title:"Editar Meta",
