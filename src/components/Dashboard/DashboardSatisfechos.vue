...
export default {
  ...
  methods: {
    ...
    getMetaRegion(){
            axios.get(process.env.VUE_APP_SERVICE_URL+'dashboard/mntosatisfechosregion')
              .then((response)=>{
    ...
    getMetasSatisfechosAlcaldias(){
      axios.get(process.env.VUE_APP_SERVICE_URL+'dashboard/mntosatisfechos')
            .then((response)=>{
                this.arreglo = response.data
            })         
            .catch(function(error){
    ...
    getMetasColoniasByDistritos(){
      ...
      axios.get(process.env.VUE_APP_SERVICE_URL+'dashboard/mntosatisfechos/'+this.alcaldias.alcaldia_id + '/' + this.distrito.distrito_id)
            .then((response)=>{
                this.arreglo = response.data
            })         
            .catch(function(error){
    ...
    getColonias(){
          axios.get(process.env.VUE_APP_SERVICE_URL+'dashboard/mntoalcaldia/'+ this.alcaldias.alcaldia_id)
              .then((response)=>{
                  this.arreglo = response.data
              })
              .catch(function(error){
    ...
    getMetasByDistrito(){
      axios.get(process.env.VUE_APP_SERVICE_URL+'dashboard/mntodistrito/'+ this.alcaldias.alcaldia_id)
              .then((response)=>{
                  this.arreglo = response.data
              })
              .catch(function(error){
    ...
    getMetasGlobalesBySector(){
              axios.get(process.env.VUE_APP_SERVICE_URL+'dashboard/mntometaporsector/'+ this.alcaldias.alcaldia_id)
              .then((response)=>{
                  this.arreglo = response.data
              })
              .catch(function(error){
