          ...
          <v-row>
            <v-col>
              <v-card class="mx-auto my-12" max-width="374">
                ...
                <v-img contain height="250" :src="editedItem.avatar"></v-img>
...
export default {
  ...
  data: () => ({
    ...
    rulesImg: [
      (value) =>
        !value || value.size < 2000000 || "Avatar debe ser menor a 2 MB",
    ],
  }),
  computed: {
    rules() {
  ...
  methods: {
    ...
    guardar() {
      ...
      if (this.validate) {
        ...
        axios
          .post(process.env.VUE_APP_SERVICE_URL + "user/editar", formData)
          .then(
            this.$swal({
              title: "Editar Perfil",
