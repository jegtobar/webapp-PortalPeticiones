<template>
    <v-container>
          <template>
            <v-row>
                <v-col class="mb-4">
                    <h1 class="display-1 text-left font-weight-bold mb-3">Seguimientos atención de solicitudes</h1>
                </v-col>
            </v-row>
            <v-row>
              <v-col 
              ...
              md="4"
              class="mb-4">
                  <v-text-field v-model="persona.vecino"
                  ...
                  <v-card-actions>
                      <v-btn color="primary" class="mr-4" @click="getPersonas()">Buscar</v-btn>
                  </v-card-actions>
              </v-col>
            </v-row>
            <v-row>
                          ...
                          <v-form
                              ...
                              <v-col
                                ...
                                <v-col
                                  ...
                                  md="4"
                                >
                                  <v-select v-model="newItem.seguimiento"
...
<!-- Modal detalle de peticiones -->
                ...
                >
                  ...
                  <v-toolbar-title><span class="text-h5">Ingresar Seguimiento: {{vecino}} </span></v-toolbar-title>
                  <v-spacer></v-spacer>
                </v-toolbar>
                    </v-card-title>
                    <v-card-text>
...
import axios from 'axios';
  ...
  export default {
    ...
    ingresarSeguimiento:{
      ...
      "actividad":"",
      "descripcion":"",
      "responsable":JSON.parse(localStorage.getItem('nombres'))+' '+JSON.parse(localStorage.getItem('apellidos'))
    },
    editarSeguimiento:{
      "id":"",
      "fecha":"",
    ...
    methods: {
      ...
      editSeguimiento (item) {
       ...
       addSeguimiento(item){
        ...
        this.ingresarSeguimiento.persona_id = this.seguimientoVecinosSatisfechos.id //Asignacion del id al campo personas_id
        // this.vecino = this.seguimientoVecinosSatisfechos.seguimiento
        this.ingresarSeguimiento.usuario_creador = JSON.parse(localStorage.getItem('username'))
      ...
      editarPersona(){
            ...
            if(this.validEdit){
              this.editedItem.usuario_actualiza = JSON.parse(localStorage.getItem('username'))
            this.editedItem.usuario_actualiza=JSON.parse(localStorage.getItem('username'))
        ...
        getPromotor(){
                axios.get(process.env.VUE_APP_SERVICE_URL+'user/promotorcoordinador/'+this.seguimientoVecinosSatisfechos.zona_id)
                .then((response)=>{
        ...
        buscarSeguimientoVecino(){
          ...
          switch (this.seguimientoVecinosSatisfechos.seguimiento) {
            case 1:
              axios.get(process.env.VUE_APP_SERVICE_URL+'gestion/seguimiento/vecinosatisfecho/'+this.seguimientoVecinosSatisfechos.id)
              .then((response)=>{
            ...
            case 3:
              axios.get(process.env.VUE_APP_SERVICE_URL+'gestion/seguimiento/vecinomuysatisfecho/'+this.seguimientoVecinosSatisfechos.id)
              .then((response)=>{
                        this.seguimiento=response.data;
                        this.loading=false
                    })
            ...
            case 4:
              axios.get(process.env.VUE_APP_SERVICE_URL+'gestion/seguimiento/mntovecinomuysatisfecho/'+this.seguimientoVecinosSatisfechos.id)
              .then((response)=>{
                        this.seguimiento=response.data;
                        this.loading=false
                    })
        ...
        guardarSeguimiento(){
            ...
            axios.post(process.env.VUE_APP_SERVICE_URL+'gestion/seguimientos/create', this.ingresarSeguimiento)
             .then((response)=>{
        ...
        putSeguimientoSatisfecho(){
          switch (this.seguimientoVecinosSatisfechos.seguimiento) {
            case 1:
               axios.put(process.env.VUE_APP_SERVICE_URL+'gestion/seguimientosatisfecho/actualizar/'+this.editarSeguimiento.id, this.editarSeguimiento)
                  .then(
                      this.$swal({
                          title:"Editar Seguimiento",
              ...
              break;
            case 2:
               axios.put(process.env.VUE_APP_SERVICE_URL+'gestion/mntoseguimientosatisfecho/actualizar/'+this.editarSeguimiento.id, this.editarSeguimiento)
                  .then(
                      this.$swal({
                          title:"Editar Seguimiento",
                          text:"Cambios guardados con éxito",
              ...
              break;
            case 3:
              axios.put(process.env.VUE_APP_SERVICE_URL+'gestion/seguimientomuysatisfecho/actualizar/'+this.editarSeguimiento.id, this.editarSeguimiento)
                  .then(
                      this.$swal({
                          title:"Editar Seguimiento",
                          text:"Cambios guardados con éxito",
              ...
              break;
            case 4:
              axios.put(process.env.VUE_APP_SERVICE_URL+'gestion/mntoseguimientomuysatisfecho/actualizar/'+this.editarSeguimiento.id, this.editarSeguimiento)
                  .then(
                      this.$swal({
                          title:"Editar Seguimiento",
                          text:"Cambios guardados con éxito",
        ...
        deleteSeguimiento (item) {
          this.editarSeguimiento = Object.assign({}, item)
            ...
            this.$swal({
                ...
                switch (this.seguimientoVecinosSatisfechos.seguimiento) {
                 case 1:
                  ...
                  axios.delete(process.env.VUE_APP_SERVICE_URL+'gestion/seguimientosatisfecho/eliminar/'+this.editarSeguimiento.id)
                    .then(()=>{
                         this.buscarSeguimientoVecino()
                      this.closeEditSeguimiento()
                    })
                 ...
                 case 2:
                   console.log(this.seguimientoVecinosSatisfechos.seguimiento)
                  axios.delete(process.env.VUE_APP_SERVICE_URL+'gestion/mntoseguimientosatisfecho/eliminar/'+this.editarSeguimiento.id)
                    .then(()=>{
                         this.buscarSeguimientoVecino()
                      this.closeEditSeguimiento()
                    })
                ...
                case 3:
                  console.log(this.seguimientoVecinosSatisfechos.seguimiento)
                 axios.delete(process.env.VUE_APP_SERVICE_URL+'gestion/seguimientomuysatisfecho/eliminar/'+this.editarSeguimiento.id)
                    .then(()=>{
                         this.buscarSeguimientoVecino()
                      this.closeEditSeguimiento()
                    })
            ...
            case 4:
              console.log(this.seguimientoVecinosSatisfechos.seguimiento)
             axios.delete(process.env.VUE_APP_SERVICE_URL+'gestion/mntoseguimientomuysatisfecho/eliminar/'+this.editarSeguimiento.id)
                    .then(()=>{
                         this.buscarSeguimientoVecino()
                      this.closeEditSeguimiento()
                    })
