<template>
    <v-container>
         <template>
            <v-row>
                <v-col class="mb-4">
                    <h1 class="display-1 text-left font-weight-bold mb-3">Mantenimiento atención de solicitudes</h1>
                </v-col>
                <v-col
                v-if="descarga=='S'">
                   <MntoMuySatisfechos/>
...
import MntoMuySatisfechos from '../Reportes/MntoMuySatisfechos.vue'
  ...
  export default {
    ...
    colonias:[],
      ...
      newItem: {
        ...
        "genero": "",
        "liderazgo": "",
        "seguimiento":"4", //Seguimiento 4 corresponde al mantenimiento vecinos muy satisfechos.
    ...
    methods: {
          ...
          if( JSON.parse(localStorage.getItem('username'))=='jfigueredo' || JSON.parse(localStorage.getItem('username'))=='jgarcia'||JSON.parse(localStorage.getItem('rol'))===1){
           ...
           this.loading=true
            if (JSON.parse(localStorage.getItem('rol'))===4||JSON.parse(localStorage.getItem('rol'))===6){
                axios.get(process.env.VUE_APP_SERVICE_URL+'persona/listaMantenimientoMuySatisfechos')
                .then((response)=>{
            ...
            {
              axios.get(process.env.VUE_APP_SERVICE_URL+'persona/listamntomuysatisfechoszonadistrito/'+JSON.parse(localStorage.getItem('alcaldia'))+'/'+JSON.parse(localStorage.getItem('distrito')))
                .then((response)=>{
              ...
              axios.get(process.env.VUE_APP_SERVICE_URL+'persona/listaMantenimientoMuySatisfechos/'+JSON.parse(localStorage.getItem('alcaldia')))
                .then((response)=>{
                    this.personas=response.data.personas
                    this.loading=false
        ...
        vecinosByName(){
                ...
                axios.get(process.env.VUE_APP_SERVICE_URL+'persona/lista/4/'+this.search.split(' ').join('_'))
                .then((response)=>{
                    this.search = ""
                    this.personas=response.data.persona
                    this.loading=false
      ...
      editSeguimiento (item) {
       ...
       addSeguimiento(item){
        ...
        this.mntoVecinosSatisfechos.persona_id = this.seguimientoVecinosSatisfechos.id //Asignacion del id al campo personas_id
        this.mntoVecinosSatisfechos.usuario_creador = JSON.parse(localStorage.getItem('username'))
      ...
      editarPersona(){
        ...
        guardarSeguimiento(){
            ...
            axios.post(process.env.VUE_APP_SERVICE_URL+'gestion/mntoseguimientomuysatisfecho/create', this.mntoVecinosSatisfechos)
            .then(
                 this.$swal({
        ...
        limpiarNuevo(){
           this.newItem={
             "pNombre": "",
              ...
              "genero": "",
              "liderazgo": "",
              "seguimiento":"4", //Seguimiento 1 corresponde a los vecinos satisfechos.
              "usuario_creador": JSON.parse(localStorage.getItem('username'))
          },
          this.mntoVecinosSatisfechos={
              "persona_id":"",
              "fecha":"",
              "actividad":"",
              "descripcion":""
        ...
        putMantenimiento(){
          this.editedItem.seguimiento = {
           ...
           this.$swal({
                    title: '¿Trasladar a Mantenimiento Vecinos Satisfechos?',
                    showDenyButton: true,
                    showCancelButton: true,
                    confirmButtonText: 'Si',
                    denyButtonText: `No`,
