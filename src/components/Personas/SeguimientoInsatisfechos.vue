  ...
  export default {
    ...
    colonias:[],
      ...
      newItem: {
        ...
        "genero": "",
        "liderazgo": "",
        "seguimiento":"5", //Seguimiento 5 corresponde a los vecinos insatisfechos.
    ...
    methods: {
        ...
        getPersonas(){
            ...
            if (JSON.parse(localStorage.getItem('rol'))===4){
                axios.get(process.env.VUE_APP_SERVICE_URL+'persona/insatisfechos')
                .then((response)=>{
              ...
              axios.get(process.env.VUE_APP_SERVICE_URL+'persona/insatisfechosporzona/'+JSON.parse(localStorage.getItem('alcaldia')))
                .then((response)=>{
        ...
        limpiarNuevo(){
           this.newItem={
             "pNombre": "",
              ...
              "genero": "",
              "liderazgo": "",
              "seguimiento":"5", //Seguimiento 1 corresponde a los vecinos satisfechos.
              "usuario_creador": JSON.parse(localStorage.getItem('username')),
          },
