      ...
      <v-col class="mb-4">
        ...
        <v-row align="center" justify="space-around">
          ...
          <v-btn
            ...
            v-if="
              distrito.distrito_id == '1' ||
              distrito.distrito_id == '2' ||
              distrito.distrito_id == '3'
            "
...
export default {
  ...
  methods: {
    ...
    getMetasSatisfechosAlcaldias() {
      axios
        .get(process.env.VUE_APP_SERVICE_URL + "dashboard/satisfechos")
        .then((response) => {
  ...
  mounted() {
    this.getMetasSatisfechosAlcaldias(), this.getAlcaldias();
  },
};
</script>
