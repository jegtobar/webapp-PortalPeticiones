...
export default {
  ...
  methods: {
    ...
    getMetasSatisfechosAlcaldias(){
      ...
      axios.get(process.env.VUE_APP_SERVICE_URL+'dashboard/mntosatisfechos/'+this.userData.alcaldia)
            .then((response)=>{
    ...
    getMetasColoniasByDistritos(){
      ...
      axios.get(process.env.VUE_APP_SERVICE_URL+'dashboard/mntosatisfechos/'+ this.userData.alcaldia + '/' + this.userData.distrito)
            .then((response)=>{
                this.arreglo = response.data
            })         
            .catch(function(error){
    ...
    getMetaByDistritoAlcaldia(){
      ...
      axios.get(process.env.VUE_APP_SERVICE_URL+'dashboard/mntodistritoAlcaldia/'+ this.userData.alcaldia + '/' + this.userData.distrito)
            .then((response)=>{
                this.arreglo = response.data
            })         
            .catch(function(error){
    ...
    getDistritos(){
            axios.get(process.env.VUE_APP_SERVICE_URL+'catalogo/distritos/'+this.userData.alcaldia)
                .then((response)=>{
    ...
    getColonias(){
          axios.get(process.env.VUE_APP_SERVICE_URL+'dashboard/mntoalcaldia/'+ this.userData.alcaldia)
              .then((response)=>{
                  this.arreglo = response.data
              })
              .catch(function(error){
    ...
    getSector(){
          ...
          axios.get(process.env.VUE_APP_SERVICE_URL+'catalogo/sectores/'+this.userData.alcaldia)
              .then((response)=>{
    ...
    getMetasByDistrito(){
      axios.get(process.env.VUE_APP_SERVICE_URL+'dashboard/mntodistrito/'+ this.userData.alcaldia)
              .then((response)=>{
                  this.arreglo = response.data
              })
              .catch(function(error){
    ...
    getMetasBySector(){
      axios.get(process.env.VUE_APP_SERVICE_URL+'dashboard/mntoporsector/'+ this.sector.sector)
              .then((response)=>{
                  this.arreglo = response.data
              })
              .catch(function(error){
    ...
    getMetasGlobalesBySector(){
              axios.get(process.env.VUE_APP_SERVICE_URL+'dashboard/mntometaporsector/'+ this.userData.alcaldia)
              .then((response)=>{
                  this.arreglo = response.data
              })
              .catch(function(error){
