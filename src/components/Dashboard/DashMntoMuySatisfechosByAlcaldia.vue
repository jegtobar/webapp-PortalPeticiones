...
export default {
  ...
  methods: {
    ...
    getMetasSatisfechosAlcaldias(){
      axios.get(process.env.VUE_APP_SERVICE_URL+'dashboard/mntomuysatisfechos/'+ this.userData.alcaldia)
            .then((response)=>{
    ...
    getMetasColoniasByDistritos(){
      ...
      axios.get(process.env.VUE_APP_SERVICE_URL+'dashboard/mntomuysatisfechos/'+this.userData.alcaldia + '/' + this.userData.distrito)
            .then((response)=>{
                this.arreglo = response.data
            })         
            .catch(function(error){
    ...
    getMetaByDistritoAlcaldia(){
      ...
      axios.get(process.env.VUE_APP_SERVICE_URL+'dashboard/mntomuydistritoAlcaldia/'+ this.userData.alcaldia + '/' + this.userData.distrito)
            .then((response)=>{
                this.arreglo = response.data
            })         
            .catch(function(error){
    ...
    getColonias(){
          axios.get(process.env.VUE_APP_SERVICE_URL+'dashboard/mntomuyalcaldia/'+ this.userData.alcaldia)
              .then((response)=>{
                  this.arreglo = response.data
              })
              .catch(function(error){
    ...
    getMetasByDistrito(){
      axios.get(process.env.VUE_APP_SERVICE_URL+'dashboard/mntomuydistrito/'+ this.userData.alcaldia)
              .then((response)=>{
                  this.arreglo = response.data
              })
              .catch(function(error){
    ...
    getMetasGlobalesBySector(){
              axios.get(process.env.VUE_APP_SERVICE_URL+'dashboard/mntomuymetaporsector/'+ this.userData.alcaldia)
              .then((response)=>{
                  this.arreglo = response.data
              })
              .catch(function(error){
