...
import SinMntoMuySatisfechos from "../Reportes/SinSeguimientos/MntoMuySatisfechos.vue"
    ...
    getPersonas() {
      ...
      if (
        ...
        axios
          .get(
            process.env.VUE_APP_SERVICE_URL +
              "persona/listaMantenimientoMuySatisfechos"
          )
          .then((response) => {
        ...
        axios
          .get(
            process.env.VUE_APP_SERVICE_URL +
              "persona/listamntomuysatisfechoszonadistrito/" +
    ...
    guardarSeguimiento() {
      ...
      if (this.validSeguimiento) {
        axios
          .post(
            process.env.VUE_APP_SERVICE_URL +
              "gestion/mntoseguimientomuysatisfecho/create",
