...
import MntoSatisfechos from '../Reportes/MntoSatisfechos.vue'
  ...
  export default {
    ...
    colonias:[],
      ...
      newItem: {
        ...
        "genero": "",
        "liderazgo": "",
        "seguimiento":"2", //Seguimiento 2 corresponde al mantenimiento vecinos satisfechos.
    ...
    methods: {
        getPersonas(){
          if( JSON.parse(localStorage.getItem('username'))=='jfigueredo' || JSON.parse(localStorage.getItem('username'))=='jgarcia'||JSON.parse(localStorage.getItem('rol'))===1){
           ...
           this.loading=true
            ...
            {
              axios.get(process.env.VUE_APP_SERVICE_URL+'persona/mntozonadistritosatisfechos/'+JSON.parse(localStorage.getItem('alcaldia'))+'/'+JSON.parse(localStorage.getItem('distrito')))
                .then((response)=>{
              ...
              axios.get(process.env.VUE_APP_SERVICE_URL+'persona/listaMantenimientoSatisfechos/'+JSON.parse(localStorage.getItem('alcaldia')))
                .then((response)=>{
                    this.personas=response.data.personas
                    this.loading=false
      ...
      editarPersona(){
        ...
        guardarSeguimiento(){
            ...
            axios.post(process.env.VUE_APP_SERVICE_URL+'gestion/mntoseguimientosatisfecho/create', this.mntoVecinosSatisfechos)
            .then(
                 this.$swal({
        ...
        limpiarNuevo(){
           this.newItem={
            ...
            "genero": "",
            "liderazgo": "",
            "seguimiento":"2", //Seguimiento 2 corresponde a los mantenimientos vecinos satisfechos.
            "usuario_creador": JSON.parse(localStorage.getItem('username')),
          },
        ...
        putMantenimiento(){
          this.editedItem.seguimiento = {
            "seguimiento":"4"
                ...
                this.$swal({
                    title: '¿Trasladar a Mantenimiento Muy Satisfechos?',
                    showDenyButton: true,
                    showCancelButton: true,
                    confirmButtonText: 'Si',
                    denyButtonText: `No`,
